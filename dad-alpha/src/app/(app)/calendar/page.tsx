...
const FILTERS = [
  ...
  { label: "Dad", value: "dad" as const, color: null },
  { label: "Kids", value: "kids" as const, color: null },
];
...
export default function CalendarPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* FAB */}
      <button
        className="fixed bottom-24 right-4 w-14 h-14 rounded-full dad-gradient-hero dad-editorial-shadow flex items-center justify-center z-30"
...
function EventCard({ event }: { event: CalendarEvent }) {
  ...
  return (
    <div
      className="dad-card p-4 border-l-4 flex gap-3"
      style={{ borderLeftColor: event.member_color ?? "hsl(var(--brand))" }}
    >
      ...
      {event.source !== "internal" && (
        <span className="dad-chip text-alphaai-3xs self-start">
