...
export default function ReferralPage() {
  ...
  const handleShare = async () => {
    ...
    const result = await share({
      title: "Join Dad.alpha — Get 2 Free Weeks!",
      text: `${user?.name?.split(" ")[0] ?? "A friend"} invited you to Dad.alpha! Use code ${referral.referral_code} to get 2 free weeks of Family Pro.`,
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="dad-card overflow-hidden">
              <div className="dad-gradient-hero px-6 py-6 text-center relative overflow-hidden">
                ...
                <p className="text-alphaai-sm text-on-primary/80">
                  Invite a friend to Dad.alpha — you both get 2 free weeks of Family Pro!
                </p>
              </div>
              ...
              {referral && (
                <div className="px-6 py-5">
                  ...
                  <div className="bg-surface-container rounded-xl px-4 py-3 flex items-center justify-between mb-4">
                    ...
                    <button
                      onClick={handleShare}
                      className="dad-btn-primary px-5 py-2.5"
                    >
            ...
            {referral && (
              <div className="grid grid-cols-3 gap-3">
                <div className="dad-card p-4 text-center">
