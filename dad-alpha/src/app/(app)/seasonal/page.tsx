...
export default function SeasonalPage() {
  ...
  useEffect(() => {
    ...
    api.seasonal
      .list()
      .then((data: { packs: SeasonalPack[] }) => setPacks(data.packs))
      .catch(() => {})
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-lg mx-auto px-4 pt-24 pb-24 space-y-4">
        {isLoading ? (
          ...
          packs.map((pack) => (
            <div key={pack.id} className="dad-card overflow-hidden">
              <button
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="dad-chip-secondary text-alphaai-3xs px-2 py-0">{pack.season}</span>
                  </div>
                ...
                <div className="px-5 pb-5 border-t border-border-subtle/10">
                  ...
                  <div className="mt-4">
                    <ShareButton
                      itemType="task"
                      title={pack.title}
                      text={`Check out this seasonal pack on Dad.alpha: "${pack.title}" — ${pack.checklist_items.length} items to get ready!`}
                    />
                  </div>
                </div>
              )}
