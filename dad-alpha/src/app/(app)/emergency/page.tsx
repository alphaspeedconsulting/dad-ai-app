      ...
      <main className="max-w-lg mx-auto px-4 pt-24 pb-24 space-y-6">
        {isLoading ? (
          ...
          <>
            ...
            <button onClick={handleDeactivate} className="dad-btn-outline w-full">
          ...
          <>
            <div className="dad-card p-6 text-center">
          ...
          <div className="relative bg-surface rounded-t-2xl sm:rounded-2xl w-full max-w-lg p-6 space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="dad-input min-h-[70px] resize-none"
                rows={2}
              />
            </div>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="dad-btn-outline flex-1"
              >
                Cancel
              </button>
              <button
