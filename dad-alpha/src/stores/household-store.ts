...
export const useHouseholdStore = create<HouseholdState>()((set) => ({
  ...
  createHousehold: async (name) => {
    ...
    try {
      ...
      set({ isLoading: false, error: error instanceof Error ? error.message : "Could not create household." });
      return null;
    }
  },
  ...
  joinHousehold: async (body) => {
    ...
    try {
      ...
      set({ isLoading: false, error: error instanceof Error ? error.message : "Could not join household." });
      return null;
    }
  },
  ...
  fetchHousehold: async (householdId) => {
    ...
    try {
      ...
      set({ isLoading: false, error: error instanceof Error ? error.message : "Could not load household." });
    }
  },
  ...
  fetchMembers: async (householdId) => {
    ...
    try {
      ...
      set({ isLoading: false, error: error instanceof Error ? error.message : "Could not load members." });
    }
  },
  ...
  inviteCoParent: async (householdId, body) => {
    ...
    try {
      ...
      set({ isLoading: false, error: error instanceof Error ? error.message : "Could not create invite." });
      return null;
    }
  },
  ...
  fetchUsage: async (householdId) => {
    ...
    try {
      ...
      set({ isLoading: false, error: error instanceof Error ? error.message : "Could not load usage dashboard." });
    }
  },
  ...
  fetchSyncDigest: async (householdId) => {
    ...
    try {
      ...
      set({ isLoading: false, error: error instanceof Error ? error.message : "Could not load sync digest." });
    }
  },
