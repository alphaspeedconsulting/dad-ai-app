...
const AGENTS: { type: AgentType; name: string; icon: string }[] = [
  ...
  { type: "self_care_reminder", name: "Self-Care", icon: "self_improvement" },
];
...
export function QuickCapture() {
  ...
  const handleSave = async () => {
    ...
    if (mode === "task") {
      await addInbox(trimmed, selectedAgent ?? undefined);
    ...
    <>
              ...
              <>
                ...
                <div className="relative">
                  <textarea
                    ...
                    rows={3}
                    className={`dad-input resize-none text-alphaai-sm pr-12 ${
                ...
                {mode === "note" && (
                  <div className="flex gap-1.5 overflow-x-auto dad-no-scrollbar">
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="dad-btn-primary px-4 py-2 text-alphaai-xs disabled:opacity-40 flex items-center gap-1.5"
                  >
      ...
      {!open && (
        <button
          ...
          className="fixed right-4 z-40 w-14 h-14 dad-gradient-hero rounded-full flex items-center justify-center shadow-lg hover:scale-105 active:scale-95 transition-transform"
