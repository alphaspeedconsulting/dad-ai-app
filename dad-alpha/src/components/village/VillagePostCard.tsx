...
const CATEGORY_LABELS: Record<VillagePostCategory, string> = {
  parenting_hacks: "Parenting Hack",
  gear_reviews: "Gear Review",
  sports_tips: "Sports Tips",
...
const CATEGORY_ICONS: Record<VillagePostCategory, string> = {
  parenting_hacks: "lightbulb",
  gear_reviews: "reviews",
  sports_tips: "sports_soccer",
  work_life_balance: "work",
  wins: "emoji_events",
  questions: "help",
  general: "forum",
};
