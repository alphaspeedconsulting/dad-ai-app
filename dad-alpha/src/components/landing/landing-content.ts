...
export const DAY_TIMELINE = [
  ...
  },
  {
    ...
    body: "Family SUV hits 36k miles next week. Garage tracker flagged it — tap to book the shop and log it to budget.",
  ...
  },
  {
    ...
    icon: "school",
    title: "School alert",
    body: "Field trip form due Friday. School Hub surfaced it from your inbox while you were in the driveway.",
    agent: "School Hub",
  },
  {
    time: "12:15 PM",
    icon: "yard",
    title: "Yard project",
    body: "Back fence repair logged to Home Projects — materials cost split across this week’s budget.",
    agent: "Expense Tracker",
  },
  {
    time: "3:00 PM",
  ...
  },
  {
    time: "5:30 PM",
    icon: "outdoor_grill",
    title: "Weekend grill plan",
    body: "Grocery Planner builds a Saturday cookout list — ribs, corn, the works — and adds it to the shared cart.",
  ...
  },
  {
    ...
    icon: "restaurant",
    title: "Dinner sorted",
    body: "Pantry check done. Grocery Planner suggests a quick weeknight meal with what’s already in the house.",
    agent: "Grocery Planner",
  },
  {
    time: "9:00 PM",
    icon: "bedtime",
    title: "Handoff note",
    body: "Quick summary for your partner: oil change booked, fence job logged, Saturday grill list ready.",
    agent: "Alpha.Dad",
  },
] as const;
