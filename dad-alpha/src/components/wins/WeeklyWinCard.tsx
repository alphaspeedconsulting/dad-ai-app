...
const AGENT_ICONS: Record<AgentType, string> = {
  ...
  self_care_reminder: "sports_and_outdoors",
};
...
export function WeeklyWinCard({ win, userName }: WeeklyWinCardProps) {
  ...
  return (
    <div className="dad-win-card overflow-hidden rounded-2xl" id="win-card">
      {/* Header gradient */}
      <div className="dad-gradient-hero px-6 py-5 relative overflow-hidden">
